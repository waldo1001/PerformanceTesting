codeunit 70100 "Telemetry Signals"
{
    ...
    begin
        ...
        TelemetryCustomDimensions.Add('DurationMs', format(CurrentDateTime - StartTestSuiteSignal));
    ...
    begin
        ...
        TelemetryCustomDimensions.Add('DurationMs', format(CurrentDateTime - StartTestCodeunit));
